...
export default function ProjectPages() {
  const projects = [
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            A mobile app to help memorize Japanese vocabulary with flashcards
            and the spaced repetition mechanism.
          </p>
          <p className="pt-3">
            The app was published on both the App Store and Google Play Store,
            having <span className="text-primary">35K+ downloads</span> ,{" "}
            <span className="text-primary">4.5+ average star rates</span>,{" "}
            <span className="text-primary">3K+ monthly active users</span>, and{" "}
            <span className="text-primary">
              150+ monthly active subscriptions
            </span>
            .
          </p>
          <p className="pt-3">
  ...
  const projects2 = [
    {
      title: "Cuby",
      link: "https://apps.apple.com/us/app/cuby-intuitive-cube-timer/id1583455340",
      content:
    ...
    },
    {
      ...
      content:
        "A simple application that can list GitHub repositories of specific users.",
    ...
    },
    {
      title: "Dominion",
      content:
        'A replica of the famous board game "Dominion" using JavaFX and sockets.',
    ...
    },
    {
      ...
      content:
        "A replica of a classic game, Tetris, developed with pure Javascript + HTML canvas.",
  ...
  return (
    <div className="pt-12 lg:pt-24">
      ...
      <section className="pt-20 pb-40 page-px">
